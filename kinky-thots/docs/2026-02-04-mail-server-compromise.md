...
**Compromised password:** `iMaTiOn@081903` (the same password listed in CLAUDE.md for the mail webui)
...
The `admin@kinky-thots.com` password (`iMaTiOn@081903`) was compromised. This password was:
