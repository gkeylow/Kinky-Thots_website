...
# Access database
docker-compose exec db mysql -u root -pjamie22 kinky_thots
...
alias kt-db='cd /var/www/kinky-thots && docker-compose exec db mysql -u root -pjamie22 kinky_thots'
...
docker-compose exec db mysqldump -u root -pjamie22 kinky_thots > backup.sql
