<?php
// Reset password page - standalone (no navigation needed)
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Reset Password - Kinky Thots</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        label { display: block; margin-bottom: 0.5rem; color: #b0b0b0; font-size: 0.9rem; }
        input {
            width: 100%;
        ...
        input:focus { outline: none; border-color: #0bd0f3; box-shadow: 0 0 0 3px rgba(11, 208, 243, 0.1); }
        button {
            width: 100%;
            padding: 0.875rem;
            background: linear-gradient(135deg, #f805a7, #0bd0f3);
...
<body>
    <div class="container">
        ...
        <a href="/live.php" class="back-link">Back to Site</a>
    </div>
