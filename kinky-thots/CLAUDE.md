...
- **Database**: MariaDB 10.11 (Docker: kinky-db) — root/jamie22, user gkeylow/jamie22
- **Streaming**: Owncast v0.2.4 on Linode (170.187.144.130) — admin: admin / iMaTiOn@0102
...
- **Owncast custom CSS/config**: modify via admin API (`curl -u admin:iMaTiOn@0102`)
